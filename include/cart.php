...
$minus = 0;
		...
		if($cartTotal <=1000){
			$discount = 200;
			$minus = $pricetotal+$discount;
			//echo $each_item['quantity'];
...
$i++; 
    ...
    $cart_Total = '<div id="cart_total"><h5 class="alert-success">200 pesos charge fee apply for delivery</h5><br>Cart Total : &#8369;'.$cartTotal. '</div>';
   }
   else{
